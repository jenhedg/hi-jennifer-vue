<template>
  <section class="resume">
    ...
    <p class="resume__copy">
      ...
      web techno, content management and marketing objectives. This experience, along with my
    ...
    <div class="resume__pos">
      ...
      <p
        class="resume__copy"
      >Partner with business teams to create seamless web experiences that drive sales. Support, maintain and improve legacy eCommerce marketing codebase. Improve site performances and improve accessibility.</p>
    </div>
    <div class="resume__pos">
      <h3 class="resume__title">
        Front-End Developer,
