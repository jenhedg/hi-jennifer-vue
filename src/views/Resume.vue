<template>
  <section class="resume">
    <div class="resume__header">
      ...
      <div class="resume__contact">
        <ul class="contact__inner--top">
          ...
          <li>
            <a class="hover--grow" href="#" target="_blank">jennifernhf@gmail.com</a>
          </li>
          <li>
            <a class="hover--grow" href="#" target="_blank">hi-jennifer.com</a>
          </li>
        </ul>
    ...
    <div class="resume__ed">
      <h3>MiraCosta College</h3>
      <h4>AA, Web Development &amp; Design, 2015</h4>
    </div>
    <div class="resume__ed">
      <h3>The University of Arizona</h3>
      <h4>BA, Latin American Studies &amp; Political Science, 2007</h4>
    </div>
  </section>
</template>
<script>
